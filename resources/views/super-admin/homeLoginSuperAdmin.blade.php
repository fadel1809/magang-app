    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{route('superadmin.home',['id'=>$user->id])}}">
            ...
            <li class="nav-item">
                <a class="nav-link" href={{route('superadmin.users',['id'=>$user->id])}} >
                    <i class="fas fa-solid fa-user"></i>
                    <span>Users</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link"  href={{route('superadmin.companies',['id'=>$user->id])}} >
                    <i class="fas fa-solid fa-building"></i>
                    <span>Companies</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href={{route('superadmin.lowongan',['id'=>$user->id])}} >
                    <i class="fa-solid fa-laptop"></i>
                    <span>Lowongan</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link"  href={{route('superadmin.lamaran',['id'=>$user->id])}} >
                    <i class="fa-solid fa-paperclip"></i>
                    <span>Lamaran</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href={{route('superadmin.pemagangAktif',['id'=>$user->id])}} >
                    <i class="fa-solid fa-suitcase"></i>
                    <span>Pemagang Aktif</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href={{route('superadmin.pemagangInAktif',['id'=>$user->id])}} >
                    <i class="fa-solid fa-person-running"></i>
                    <span>Pemagang tidak aktif</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href={{route('superadmin.pending.companies',['id'=>$user->id])}} >
                    <i class="fa-solid fa-list-check"></i>
                    <span>Daftar Masuk Perusahaan</span>
                </a>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">super admin {{$user->name}}</span>
                                @if($user->photo)
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-danger shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Companies
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                    @if(isset($companiesCount))
                                                    {{ $companiesCount}}
                                                    @else
                                                    0
                                                    @endif
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                                Perusahaan ingin bergabung</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-list-check fa-solid fa-2x text-gray-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
